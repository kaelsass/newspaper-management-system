...
public class QuestionDaoImpl implements QuestionDao {
	...
	private static final String GET_ALL = "select seq, name from s_question order by seq";
	private static final String GET_BY_SEQ = "select seq, name from s_question where seq = ?";
	private static final String GET_BY_NAME = "select seq, name from s_question where name = ?";
	private static final String INSERT = "insert into s_question ( name) values ( ?)";
	private static final String UPDATE = "update s_question set name = ? where seq = ?";
	private static final String DELETE = "delete from s_question where seq = ?";
