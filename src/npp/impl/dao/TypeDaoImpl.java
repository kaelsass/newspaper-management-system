...
public class TypeDaoImpl implements TypeDao {
	...
	private static final String GET_ALL = "select seq, name from N_QUESTION_TYPE order by seq";
	private static final String GET_BY_SEQ = "select seq, name from N_QUESTION_TYPE where seq = ?";
	private static final String INSERT = "insert into N_QUESTION_TYPE ( name) values ( ?)";
	private static final String UPDATE = "update N_QUESTION_TYPE set name = ? where seq = ?";
	private static final String DELETE = "delete from N_QUESTION_TYPE where seq = ?";
