...
public class StatusDaoImpl implements StatusDao {
	...
	public List<StatusDto> getAllList(Transaction transaction) throws IOException {
		...
		try {
			...
			while (resultSet.next()) {
				...
				StatusDto dto = makeDto(transaction, resultSet);
				items.add(dto);
			}
			return items;
	...
	private static final String GET_ALL = "select seq, name from s_status order by seq";
	private static final String GET_BY_SEQ = "select seq, name from s_status where seq = ?";
	private static final String GET_BY_NAME = "select seq, name from s_status where name = ?";
	private static final String INSERT = "insert into s_status ( name) values ( ?)";
	private static final String UPDATE = "update s_status set name = ? where seq = ?";
	private static final String DELETE = "delete from s_status where seq = ?";
