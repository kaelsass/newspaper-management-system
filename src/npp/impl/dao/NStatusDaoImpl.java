...
//@Stateless
public class NStatusDaoImpl implements NStatusDao {
	...
	private static final String GET_ALL = "select seq, name from n_status order by seq";
	private static final String GET_BY_SEQ = "select seq, name from n_status where seq = ?";
	private static final String GET_BY_NAME = "select seq, name from n_status where name = ?";
	private static final String INSERT = "insert into n_status ( name) values ( ?)";
	private static final String UPDATE = "update n_status set name = ? where seq = ?";
	private static final String DELETE = "delete from n_status where seq = ?";
