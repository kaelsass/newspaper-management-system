...
//@Stateless
public class GoalTypeDaoImpl implements GoalTypeDao {
	...
	private static final String GET_ALL = "select seq, name from s_goal_type order by seq";
	private static final String GET_BY_SEQ = "select seq, name from s_goal_type where seq = ?";
	private static final String GET_BY_NAME = "select seq, name from s_goal_type where name = ?";
	private static final String INSERT = "insert into s_goal_type ( name) values ( ?)";
	private static final String UPDATE = "update s_goal_type set name = ? where seq = ?";
	private static final String DELETE = "delete from s_goal_type where seq = ?";
