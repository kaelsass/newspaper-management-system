...
//@Stateless
public class GoalStatusDaoImpl implements GoalStatusDao {
	...
	private static final String GET_ALL = "select seq, name from s_goal_status order by seq";
	private static final String GET_BY_SEQ = "select seq, name from s_goal_status where seq = ?";
	private static final String GET_BY_NAME = "select seq, name from s_goal_status where name = ?";
	private static final String INSERT = "insert into s_goal_status ( name) values ( ?)";
	private static final String UPDATE = "update s_goal_status set name = ? where seq = ?";
	private static final String DELETE = "delete from s_goal_status where seq = ?";
